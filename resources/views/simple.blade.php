...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        <div class="container">
            <div class="col-md-12">
                <h2 class="text-center my-5">Ajax Multiple Column Filter (Simple Table)  <span><a  class="btn btn-primary" href="{{route('dataTable')}}">DataTable</a></span> </h2>
                <div class="row">
                    <div class="col-md-3">
            ...
            const loadTable = () =>{
                $.ajax({
                    ...
                    success:function ({data}) {
                        ...
                        let table_row = ``;
                        data.forEach(branch=>{
                            table_row += `<tr><td>${branch.name}</td><td>${branch.division}</td><td>${branch.address}</td><td>${branch.contact}</td></tr>`;
                        })
